...
public static class AddUtilityBillEndpoint
{
    public static void MapAddUtilityBillEndpoint(this IEndpointRouteBuilder app)
    {
        app.MapPost("/api/utility-bill-periods/{id}/utility-bills", HandleAddUtilityBill)
